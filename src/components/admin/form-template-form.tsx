  ...
  return (
    <ActionForm action={saveFormTemplateAction} successMessage="Template saved.">
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <Field label="Form number"><input name="formNumber" defaultValue={template?.formNumber} required placeholder="I-130" className={inputClass} /></Field>
      ...
      <div className="mt-3">
        <Field
          label="Official USCIS PDF URL"
          hint="The real USCIS form, e.g. https://www.uscis.gov/sites/default/files/document/forms/i-485.pdf — downloads are generated by infusing the customer's answers into this PDF."
        >
          <input name="pdfSourceUrl" defaultValue={template?.pdfSourceUrl ?? ""} placeholder="https://www.uscis.gov/sites/default/files/document/forms/i-485.pdf" className={inputClass} />
        </Field>
      </div>
      <div className="mt-3">
        <Field
          label="PDF field mapping (JSON)"
          hint='Maps wizard answers to the PDF&apos;s field names (see "Detected PDF fields" below): [{"field":"topmostSubform[0].Page1[0].f1_3[0]","source":"name","transform":"first_words"},{"field":"…date[0]","source":"filing_date"}]. Transforms: first_words, last_word, street, city_state_zip, money.'
        >

...
export function CaseUpload({ caseId }: { caseId: string }) {
  ...
  return (
    <form action={formAction} className="space-y-2">
      ...
      <input type="file" name="files" multiple className="block w-full text-xs text-slate-500 file:mr-2 file:rounded-lg file:border-0 file:bg-orange-50 file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-orange-700" />

    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-16">
        <div className="text-center">
          ...
          <p className="mt-2 text-slate-600">Start free. Upgrade when you want the full toolkit. Visitors get one short official answer; Free keeps a few general questions each month; Plus personalizes follow-ups; Pro can match you with a licensed professional on this platform.</p>
        </div>

...
function NewCaseForm() {
  // Guide / Q&A handoff: describe what is going on — router chooses Situation vs Case.
      ...
      <ActionForm action={createCaseAction}>
        <div className="space-y-5 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <p className="text-xs text-slate-500">
            ImmigrationOnMe decides whether this is a Situation or a government Case from what you describe.
            You will never be asked to “open a case” as an internal setting.
          </p>

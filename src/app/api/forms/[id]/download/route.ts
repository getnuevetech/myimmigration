...
// Downloadable copy of a completed USCIS form. Whether this requires a paid
...
<footer>
  This worksheet mirrors the layout of the official USCIS form to make transferring your answers easy. Always compare against
  the current official USCIS form before filing. Prepared by ${esc(appName)} — not the USCIS, a law firm, or a law firm.
</footer>
</body>
</html>`;

...
const NAV: { area: string; href: string; label: string; section: string }[] = [
  ...
  { area: "admin.cases", href: "/admin/reanalysis", label: "Case re-analysis", section: "Intelligence" },
  ...
  { area: "admin.experience", href: "/admin/experience", label: "Pattern Registry", section: "Intelligence" },
      ...
      <header className="border-b border-slate-800 bg-slate-900 text-white">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-4">
          <Link href="/admin" className="flex items-center gap-2 font-bold">
            <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-lime-500 text-xs font-bold">M</span>

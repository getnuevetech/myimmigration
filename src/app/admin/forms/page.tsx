...
export const metadata = { title: "USCIS form templates" };
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4 rounded-xl border border-slate-200 bg-slate-50/60 p-4">
                    <div className="flex flex-wrap items-center justify-between gap-3">
                      <div>
                        <p className="text-sm font-semibold text-slate-900">Official USCIS PDF</p>
                        <p className="text-xs text-slate-500">
                          {t.pdfPath
                            ...
                            : t.pdfSourceUrl
                              ...
                              : "Set the official USCIS PDF URL above and save, then fetch to see its fillable fields."}
                        </p>
                      </div>

...
export default async function AdminPlansPage() {
  ...
  return (
    <div>
      ...
      <Card className="mb-8">
        <CardBody>
          <h2 className="mb-2 text-sm font-semibold text-slate-900">Consultant / immigration professional subscriptions</h2>
          <p className="mb-3 text-xs text-slate-500">
            When enabled, consultants must hold an active partner plan (audience: Immigration Consultants) to accept new client
          ...
          <Card key={p.id}>
            <CardBody>
              <div className="mb-3 flex items-center gap-2">
                ...
                <Badge>{p.key}</Badge>
                <Badge color={p.audience === "consultant" ? "lime" : "lime"}>

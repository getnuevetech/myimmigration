-- Phase S: first-class Situation + FilingPlan; Case links to Situation; Document/QaThread optional situationId
...
CREATE TABLE IF NOT EXISTS "FilingPlan" (
    "id" TEXT NOT NULL,
    ...
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    CONSTRAINT "FilingPlan_pkey" PRIMARY KEY ("id")
);

CREATE INDEX IF NOT EXISTS "FilingPlan_situationId_idx" ON "FilingPlan"("situationId");
...
DO $$ BEGIN
  ALTER TABLE "FilingPlan" ADD CONSTRAINT "FilingPlan_situationId_fkey" FOREIGN KEY ("situationId") REFERENCES "Situation"("id") ON DELETE CASCADE ON UPDATE CASCADE;
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
